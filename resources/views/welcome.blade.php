        ...
        <div class="mx-0 sm:mx-6">
                    ...
                    <div class="flex h-full bg-white rounded overflow-hidden shadow-lg">
                        <a href="{{ route('post.show', $firstPost['id']) }}"
                            ...
                            <div class="w-full md:w-2/3 rounded-t">
                                @if ($firstPost->image)
                                    <img src="{{ url('storage/' . $firstPost->image) }}" class="h-64 w-full rounded-t pb-6">
                                @else
                            ...
                            <div class="w-full md:w-1/3 flex flex-col flex-grow flex-shrink">
                                <div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow-lg">
                                    <p class="w-full text-gray-600 text-xs md:text-sm pt-6 px-6">
                                        {{ $firstPost['categoria']->nome }}</p>
                                    <div class="w-full font-bold text-xl text-gray-900 px-6">{{ $firstPost['titulo'] }}
                                    </div>
            ...
            @else
                ...
                <div class="container font-sans bg-green-100 rounded mt-8 p-4 md:p-24 text-center">
                    <h2 class="font-bold break-normal text-2xl md:text-4xl">Inscreva-se no nosso blog!</h2>
                    <h3 class="font-bold break-normal font-normal text-gray-600 text-base md:text-xl">Receba as nossas
                        noticias diretamente no seu E-mail</h3>
                    <div class="w-full text-center pt-4">
                        <form action="#">
                            <div class="max-w-xl mx-auto p-1 pr-0 flex flex-wrap items-center">
                                ...
                                <button type="submit"
                                    class="flex-1 mt-4 md:mt-0 block md:inline-block appearance-none bg-green-500 text-white text-base font-semibold tracking-wider uppercase py-4 rounded shadow hover:bg-green-400">Inscreva-se</button>
                            </div>
                        </form>
                    </div>
                </div>
